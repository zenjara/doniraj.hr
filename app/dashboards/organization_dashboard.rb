...
class OrganizationDashboard < Administrate::BaseDashboard
  ...
  COLLECTION_ATTRIBUTES = [:id, :name, :address, :city, :iban, :verified, :archived].freeze

  # SHOW_PAGE_ATTRIBUTES
  # an array of attributes that will be displayed on the model's show page.
  SHOW_PAGE_ATTRIBUTES = [:city, :id, :name, :address, :telephone, :email, :iban, :website, :swift, :verified, :archived, :created_at, :updated_at].freeze

  # FORM_ATTRIBUTES
  # an array of attributes that will be displayed
  # on the model's form (`new` and `edit`) pages.
  FORM_ATTRIBUTES = [:city, :name, :address, :telephone, :email, :iban, :website, :swift, :verified, :archived].freeze
